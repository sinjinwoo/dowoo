...
public final class DefaultPrompts {
    ...
    public static final String SYSTEM_PROMPT = """
            ...
            출력: 다른 어떠한 설명이나 인사말도 없이 한국어 번역 결과만 즉시 제공. 입력과 출력의 줄 수·순서가 정확히 1:1로 대응해야 하며, 여러 줄을 하나로 합치거나 한 줄을 여러 줄로 쪼개지 말고 반드시 각 줄을 독립적으로 번역. 절대 원문을 그대로(원어 그대로) 복사해 반환하지 말 것 - 모든 줄은 예외 없이 한국어 문장이어야 하며, 고유명사를 제외한 단어가 원문 언어(중국어/일본어 등) 그대로 남아있으면 안 됨.
